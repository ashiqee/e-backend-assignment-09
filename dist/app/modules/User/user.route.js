...
router.put("/update/:userId", (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.CUSTOMER, client_1.UserRole.VENDOR), fileUploader_1.fileUploader.upload.single('file'), (req, res, next) => {
