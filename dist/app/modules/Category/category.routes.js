...
router.post('/create', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.VENDOR), multer_config_1.multerUpload.single('file'), (req, res, next) => {
...
router.patch('/update/:categoryId', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.VENDOR), multer_config_1.multerUpload.single('file'), (req, res, next) => {
