...
router.post('/create-product', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.VENDOR), fileUploader_1.fileUploader.upload.array('files', 5), (req, res, next) => {
...
router.patch('/update/:id', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.VENDOR), fileUploader_1.fileUploader.upload.array('files', 5), (req, res, next) => {
